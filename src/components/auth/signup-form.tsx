...
export function SignupForm() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    setError(null);
    try {
      // The role is now fixed to 'Employee' and employeeId is generated by the server
      const user = await signup(values.name, values.email, values.password, "", 'Employee', values.department, values.position);
      if (user) {
